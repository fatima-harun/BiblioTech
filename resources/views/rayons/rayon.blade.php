...
<a href=""><h2>BiblioTech</h2></a>
    ...
    <a href="#"><box-icon name='log-out-circle' color='#ffffff'></box-icon>Déconnexion</a>
        ...
        <div class="col-md-10">
            <div class="content">
                <h2 class="mt-4 mb-4">Ajouter un rayon</h2>
                <form action="{{route('ajoutrayon')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="libelle">Libellé</label>
                        <input type="text" class="form-control" id="libelle" name="libelle" placeholder="Entrez le libellé du rayon" required>
                    </div>
                    <div class="form-group">
                        <label for="description">Partie</label>
                        <textarea class="form-control" id="description" name="partie" rows="3" placeholder="Entrez la partie du rayon" ></textarea>
                    </div>
